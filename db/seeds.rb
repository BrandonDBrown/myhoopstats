...
User.create!(name: "brandong brown", email: "brandon.bbrandon@gmail.com", password: "foobar", password_confirmation: "foobar", admin: true, ftgoal: 0, jsgoal: 0, activated: true, activated_at: Time.zone.now)
